(() => {
  ...
  var body_default = `<div class=page__content><h1 class="page__title centered__text">Japanese Cheat Sheet</h1><blockquote class=legend id=legend><a class="icon__button toggle" id=toggle-legend title="Toggle legend" tabindex=-1><img src=../../assets/plus.svg id=plus alt="Plus icon">
<img src=../../assets/minus.svg id=minus alt="Minus icon" class=hidden>
...
soundtracks.
<a href=https://x.com/hamboorglar target=_blank rel="noopener noreferrer">Jordi</a></small></div><a href=https://github.com/izquiratops/japanese-cheat-sheet target=_blank rel="noopener noreferrer" title="Fork me on Github!" tabindex=-1><img src=../../assets/github-mark.svg class=github__logo alt="Github logo">
</a><a class="icon__button jump" id=scroll-to-top title="Scroll to the top \u{1F998}" tabindex=-1><img src=../../assets/scroll-to-top.svg alt="Scroll to top icon"></a>`;
